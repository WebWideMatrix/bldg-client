...
Shader "CandleFlamesShaders/Fire_LookAtCamera_BorderSmooth"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float4 normalizeResult12_g1 = normalize( UNITY_MATRIX_T_MV[0] );
				float4 normalizeResult11_g1 = normalize( UNITY_MATRIX_T_MV[1] );
				float4 normalizeResult10_g1 = normalize( UNITY_MATRIX_T_MV[2] );
				float Size83 = _Size;
				float3 LOOK_AT_OUT300 = mul( float3x3(normalizeResult12_g1.xyz, normalizeResult11_g1.xyz, normalizeResult10_g1.xyz), ( Size83 * v.vertex.xyz ) );
				
				float3 vertexPos2_g2 = LOOK_AT_OUT300;
				float4 ase_clipPos2_g2 = UnityObjectToClipPos(vertexPos2_g2);
				float4 screenPos2_g2 = ComputeScreenPos(ase_clipPos2_g2);
				o.ase_texcoord2 = screenPos2_g2;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 uv072 = i.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 GLOW_OUT289 = ( ColorGlow286 * tex2D( _Glow, uv072 ).r );
				float3 appendResult79 = (float3(_Color.rgb));
				float3 Color292 = appendResult79;
				float Size83 = _Size;
				float SizeFireMul343 = _SizeFireMultiply;
				float temp_output_346_0 = ( Size83 * SizeFireMul343 );
				float2 temp_cast_2 = (( temp_output_346_0 + 1.0 )).xx;
				float2 uv09 = i.ase_texcoord1.xy * temp_cast_2 + float2( 0,0 );
				float2 temp_cast_3 = (( temp_output_346_0 / 2.0 )).xx;
				...
				float4 screenPos2_g2 = i.ase_texcoord2;
				float4 ase_screenPosNorm2 = screenPos2_g2 / screenPos2_g2.w;
				ase_screenPosNorm2.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm2.z : ase_screenPosNorm2.z * 0.5 + 0.5;
				float screenDepth2_g2 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm2.xy ));
				float distanceDepth2_g2 = abs( ( screenDepth2_g2 - LinearEyeDepth( ase_screenPosNorm2.z ) ) / ( _SmoothBorder1 ) );
				float clampResult3_g2 = clamp( distanceDepth2_g2 , 0.0 , 1.0 );
				float SMOOTH_BOREDER_OUT339 = clampResult3_g2;
...
/*ASEBEGIN
Version=18100
1360;73;922;926;4233.097;91.8292;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;278;-4048,512;Inherit;False;1160.133;1136.582;;25;79;77;6;120;71;286;76;74;122;121;125;124;114;134;113;89;88;117;83;131;116;54;292;342;343;INPUT_DATA;0,0.9917374,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-3520,1088;Inherit;False;Property;_Size;Size;9;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;116;-3472,768;Inherit;False;Property;_TimeScale;TimeScale;6;0;Create;True;0;0;False;0;False;1;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;342;-3527.583,1189.221;Inherit;False;Property;_SizeFireMultiply;SizeFireMultiply;13;0;Create;True;0;0;False;0;False;1;1.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;297;-4048,-48;Inherit;False;2082;438;;19;70;9;90;69;82;68;66;138;147;91;93;29;7;293;78;295;346;344;345;FIRE;1,0.1554603,0,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;343;-3143.583,1205.221;Inherit;False;SizeFireMul;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;344;-4032.676,265.3549;Inherit;False;343;SizeFireMul;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;345;-4032.042,176.1043;Inherit;False;83;Size;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;346;-3857.574,177.0533;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;118;-3999.241,-439.5437;Inherit;False;117;TimeScale;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;88;-3440,976;Inherit;False;Property;_UVClamp;UV Clamp;10;0;Create;True;0;0;False;0;False;1;0.894;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;113;-3472,864;Inherit;False;Property;_NoiseSize;NoiseSize;5;0;Create;True;0;0;False;0;False;1;0.35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;124;-3552,560;Inherit;False;Property;_NoiseUVLock;NoiseUVLock;8;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;119;-2751.241,-711.5436;Inherit;True;Property;_TextureSample2;Texture Sample 2;4;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;120;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;121;-3568,656;Inherit;False;Property;_NoiseFactor;NoiseFactor;7;0;Create;True;0;0;False;0;False;0;0.26;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;74;-3984,1248;Inherit;False;Property;_Color_Glow;Color_Glow;2;1;[HDR];Create;True;0;0;False;0;False;0.6509434,0.4870858,0.3531061,0;0.5660378,0.3536974,0.2162692,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;298;-2800,512;Inherit;False;594.5172;156.4827;Comment;3;300;340;85;LOOK_AT_CAMERA;0.04096198,1,0,1;0;0
Node;AmplifyShaderEditor.SimpleAddOpNode;91;-3056,144;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;77;-3984,1424;Inherit;False;Property;_Color;Color;0;1;[HDR];Create;True;0;0;False;0;False;1,1,1,0;1.498039,1.498039,1.498039,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;85;-2784,560;Inherit;False;83;Size;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;287;-4032,-1280;Inherit;False;942.2849;369;;5;289;75;285;73;72;GLOW;1,0.7722037,0,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;340;-2608,560;Inherit;False;LookAtCamera;-1;;1;9b30a97c3cbc350439468eb1d5ba80d6;0;1;5;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;300;-2400,560;Inherit;False;LOOK_AT_OUT;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;285;-3648,-1232;Inherit;False;286;ColorGlow;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;73;-3760,-1136;Inherit;True;Property;_TextureSample1;Texture Sample 1;3;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;LockedToTexture2D;False;Instance;71;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;293;-2528,0;Inherit;False;292;Color;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;75;-3440,-1136;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;301;-2800,720;Inherit;False;865.7219;432.8958;;7;338;234;299;330;80;296;290;OUT;0.9751091,0,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;341;-2560,1280;Inherit;False;SmoothBorder;11;;2;6e5b5da19764aa24d9e31fc6220bb2ab;0;1;4;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;289;-3296,-1136;Inherit;False;GLOW_OUT;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;299;-2416,976;Inherit;False;300;LOOK_AT_OUT;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;71;-4000,816;Inherit;True;Property;_Glow;Glow;3;0;Create;True;0;0;False;0;False;-1;None;71b330055cdae7d438bb0d46ea78e928;True;0;False;white;LockedToTexture2D;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;234;-2176,880;Float;False;True;-1;2;ASEMaterialInspector;100;1;CandleFlamesShaders/Fire_LookAtCamera_BorderSmooth;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;4;1;False;-1;1;False;-1;0;4;False;-1;1;False;-1;True;0;False;-1;0;False;-1;True;False;True;0;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;False;0;False;-1;0;False;-1;True;1;RenderType=Overlay=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;0;0;1;True;False;;0
...
WireConnection;340;5;85;0
WireConnection;292;0;79;0
WireConnection;286;0;76;0
WireConnection;300;0;340;0
...
ASEEND*/
//CHKSM=1CB47F8F3B50CA94C74E9A3357F9C88640027B77